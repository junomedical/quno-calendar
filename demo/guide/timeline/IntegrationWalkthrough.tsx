...
const readOnlySnippet = `<QunoCalendar
  calendars={calendars}
...
<QunoCalendar ref={calendarRef} {...calendarProps} />`;
...
const dateLocalizationSnippet = `import type { DayNameGenerator } from "@quno/calendar/timeline";
    ...
    <Root className="calendar-article" data-testid="calendar-article">
      <article className="calendar-article__content">
        ...
        <ArticleSection id="infinite-view" number="01" title="Vertical and infinite">
          ...
          <p>
            The browser never pays for an actually infinite page. Quno Calendar renders a fixed window around the
            visible dates, then recenters that window after scrolling stops while preserving the exact position inside
            the day. Moving three years costs roughly the same as moving three days.
          </p>
          <Callout>
        ...
        <ArticleSection id="performance" number="02" title="Fast in the busiest times">
          ...
          <p>
            Quno Calendar limits work to the dates, resources, and cards near the viewport. It calculates overlap once,
            reuses rendered card content, and groups pointer and zoom updates by animation frame. These choices target
            smooth 60–120fps scrolling on suitable hardware.
          </p>
          <p>
        ...
        <ArticleSection id="react-integration" number="21" title="Plays nice with React">
          <p>
            Quno Calendar behaves like a React component, not a second application hidden inside one. Your app remains
            the source of truth for resources, permissions, persistence, settings, and product UI; the calendar handles
            layout and reports interaction proposals.
          </p>
          <p>
        ...
        <ArticleSection id="package-footprint" number="24" title="Payload size">
          <p>
            Quno Calendar adds 32.91 KiB gzip of its own JavaScript and CSS to a production application. Because a
          ...
          <div className="article-footprint" data-testid="article-package-footprint">
            <dl aria-label="Production transfer payload">
              <div>
                <dt>JavaScript</dt>
                <dd>
                  <strong>31.12 KiB gzip</strong>
                  <span>126.21 KiB raw</span>
                </dd>
              </div>
              <div>
                <dt>Styles</dt>
                <dd>
                  <strong>1.78 KiB gzip</strong>
                  <span>8.66 KiB raw</span>
                </dd>
              </div>
              <div>
                <dt>Total package</dt>
                <dd>
                  <strong>32.91 KiB gzip</strong>
                  <span>134.87 KiB raw</span>
                </dd>
              </div>
            </dl>
