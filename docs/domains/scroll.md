...
| [`useVerticalProjectionRenderWindow.ts`](../../src/lib/timeline/infinite/scroll/window/useVerticalProjectionRenderWindow.ts) | Keeps the semantic top-date window on new base-day geometry while vertical zoom measurements settle.                     |
