...
The source tree is organized by **ownership**, while [`docs/flows`](../flows/README.md) is organized by **execution order**. A domain answers “who owns this state or decision?”; a flow answers “what happens next?”.
