...
| [`eventMembershipIndex.ts`](../../src/lib/infinite/events/indexing/eventMembershipIndex.ts)            | Indexes cached events by calendar while preserving multi-calendar semantics.      |
| [`eventIntervals.ts`](../../src/lib/infinite/events/layout/eventIntervals.ts)                          | Converts events into clipped, sortable timeline intervals.                        |
| [`minHeap.ts`](../../src/lib/infinite/events/layout/minHeap.ts)                                        | Reuses the earliest available overlap lane in logarithmic time.                   |
| [`preparedCell.ts`](../../src/lib/infinite/events/layout/preparedCell.ts)                              | Produces the deterministic overlap model shared by sizing and rendering.          |
| [`rowLayout.ts`](../../src/lib/infinite/events/layout/rowLayout.ts)                                    | Projects a prepared cell into horizontal lanes and row height.                    |
| [`columnLayout.ts`](../../src/lib/infinite/events/layout/columnLayout.ts)                              | Projects a prepared cell into vertical columns and growth width.                  |
| [`layout.ts`](../../src/lib/infinite/events/layout/layout.ts)                                          | Exposes the layout-domain facade and compatibility helpers.                       |
| [`activeDrafts.ts`](../../src/lib/infinite/events/metrics/activeDrafts.ts)                             | Removes the persisted source event while its edit draft is rendered externally.   |
| [`useDayMetrics.ts`](../../src/lib/infinite/events/metrics/useDayMetrics.ts)                           | Builds horizontal prepared cells and cached resource/day heights.                 |
| [`useRetainedCalendarRows.ts`](../../src/lib/infinite/events/metrics/useRetainedCalendarRows.ts)       | Retains hidden draft resources until their transient instance is released.        |
| [`useVerticalPreparedColumns.ts`](../../src/lib/infinite/events/metrics/useVerticalPreparedColumns.ts) | Builds vertical prepared cells, column widths, and lookup functions.              |
