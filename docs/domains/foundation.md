...
| [`internalTypes.ts`](../../src/lib/core/internalTypes.ts)                             | Separates view handles and focused-instance state from the public contract.            |
| [`types.ts`](../../src/lib/core/types.ts)                                             | Defines the public API, events, settings, renderers, navigation, and anchor contracts. |
| [`useCalendarFocusCoordinator.ts`](../../src/lib/core/useCalendarFocusCoordinator.ts) | Coordinates focus, participant reveal, cancellation, and highlight state.              |
| [`useCalendarFocusEffects.ts`](../../src/lib/core/useCalendarFocusEffects.ts)         | Settles focus requests and owns transient cancellation/highlight effects.              |
