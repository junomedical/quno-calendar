...
| Source file                                                                                                          | Responsibility                                                              |
| -------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| [`HorizontalTimelineCanvas.tsx`](../../src/lib/infinite/rendering/horizontal/HorizontalTimelineCanvas.tsx)           | Renders the scroll container, sticky time scale, and virtual date items.    |
| [`HorizontalTimelineDay.tsx`](../../src/lib/infinite/rendering/horizontal/HorizontalTimelineDay.tsx)                 | Renders one measured date header and its windowed resource rows.            |
...
| [`useHorizontalViewportSizing.ts`](../../src/lib/infinite/rendering/horizontal/useHorizontalViewportSizing.ts)       | Derives effective horizontal viewport width and timeline scale geometry.    |
| [`types.ts`](../../src/lib/infinite/rendering/horizontal/types.ts)                                                   | Defines prepared render contracts shared by horizontal layers.              |
...
| Source file                                                                  | Responsibility                                                    |
| ---------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| [`calendar.css`](../../src/lib/infinite/rendering/styles/calendar.css)       | Declares the explicit stylesheet entry and import order.          |
| [`base.css`](../../src/lib/infinite/rendering/styles/base.css)               | Defines shared viewport, date, resource, and interaction styling. |
| [`horizontal.css`](../../src/lib/infinite/rendering/styles/horizontal.css)   | Defines horizontal sticky and timeline geometry.                  |
| [`vertical.css`](../../src/lib/infinite/rendering/styles/vertical.css)       | Defines vertical board, column, and time-axis geometry.           |
| [`event-shell.css`](../../src/lib/infinite/rendering/styles/event-shell.css) | Defines event shell containment, states, and renderer isolation.  |
