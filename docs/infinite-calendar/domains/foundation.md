...
```mermaid
flowchart LR
  Facade["Package facade"] --> Root["QunoInfiniteCalendar"]
...
| [`calendarCellTypes.ts`](../../../src/lib/timeline/core/calendarCellTypes.ts)                     | Defines calendar identity, orientation, and date/resource presentation contracts. |
| [`calendarCellPresentation.ts`](../../../src/lib/timeline/core/calendarCellPresentation.ts)       | Resolves one orientation-neutral date/resource presentation context.              |
