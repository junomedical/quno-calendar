...
| --- | --- | --- |
| Calendar surface | The whole reusable calendar component area, excluding demo sidebar controls. | `CalendarRoot`, `InfiniteTimelineView` |
| View | A swappable calendar presentation inside `CalendarRoot`. The current PoC view is the infinite timeline. | `view="infinite"` |
| Infinite timeline | The implemented view where dates flow vertically and time flows horizontally. | `InfiniteTimelineView` |
