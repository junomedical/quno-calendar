...
| --- | --- | --- |
| Calendar surface | The whole reusable calendar component area, excluding demo sidebar controls. | `CalendarRoot`, `InfiniteTimelineView`, `InfiniteVerticalTimelineView` |
| View | A swappable calendar presentation inside `CalendarRoot`. | `view` |
| Infinite horizontal timeline | The view where dates flow vertically, calendars render as rows, and time flows horizontally. | `view="infinite-horizontal"`, `InfiniteTimelineView` |
| Infinite vertical timeline | The view where dates and time flow vertically, while calendars render as columns from left to right. | `view="infinite-vertical"`, `InfiniteVerticalTimelineView` |
