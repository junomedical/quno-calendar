...
export function rowHeightForEvents({
  ...
  return rowHeightForPreparedCell({ preparedCell: prepareEventCell({ events, settings }), settings });
}
...
export function columnWidthForEvents({
  ...
  return columnWidthForPreparedCell({ preparedCell: prepareEventCell({ events, settings }), settings });
}
