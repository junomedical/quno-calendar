...
export function normalizeAnchorDate(dateKey: string, excludedWeekdays: number[]): IsoDate {
...
export function dateAtVirtualOffset(anchorDateKey: string, offset: number, excludedWeekdays: number[]): IsoDate {
...
export function dateRangeFromKeys(dateKeys: IsoDate[]): { startDate: IsoDate; endDate: IsoDate } | null {
